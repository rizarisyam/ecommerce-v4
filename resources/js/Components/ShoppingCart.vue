    ...
    <div class="container mx-auto mt-10">
        <div class="flex shadow-md my-10">
            <div class="w-3/4 bg-white px-10 py-10">
                ...
                <!-- product -->
                <product v-for="item in cartItems" :key="item.id" :id="item.id" :name="item.name" :price="item.price" :quantity="item.pivot.quantity" />
                <!-- <div
                ...
                >
                    ...
                    >{{ rupiahFormat(item.pivot.price) ?? "$400.00" }}</span>
                    <span class="text-center w-1/5 font-semibold text-sm">{{ rupiahFormat(item.pivot.quantity * item.pivot.price) }}</span>
                </div> -->
